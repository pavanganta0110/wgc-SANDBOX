...
const EMPTY_LINE_ITEM: LineItemForm = { description: "", detailedDescription: "", quantity: 1, unitPriceCents: 0, discountType: "FIXED", discountValue: 0, taxRateBasisPoints: null, productCode: "" };
