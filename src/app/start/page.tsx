            ...
            {step === 1 && (
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div><label className="block text-sm font-semibold mb-2">Business Tax ID (EIN)</label><input required value={formData.businessTaxId} onChange={(e) => updateField("businessTaxId", e.target.value)} className="w-full px-4 py-3 rounded-xl border outline-none focus:ring-2 focus:ring-[#eab308]" /></div>
                  ...
                  <div><label className="block text-sm font-semibold mb-2">Business Phone</label><input required type="tel" value={formData.businessPhone} onChange={(e) => updateField("businessPhone", e.target.value)} className="w-full px-4 py-3 rounded-xl border outline-none focus:ring-2 focus:ring-[#eab308]" /></div>
                  ...
                  <div><label className="block text-sm font-semibold mb-2">State</label><input required value={formData.businessState} onChange={(e) => updateField("businessState", e.target.value)} className="w-full px-4 py-3 rounded-xl border outline-none focus:ring-2 focus:ring-[#eab308]" /></div>
            ...
            {step === 3 && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div><label className="block text-sm font-semibold mb-2">Phone</label><input required type="tel" value={formData.phone} onChange={(e) => updateField("phone", e.target.value)} className="w-full px-4 py-3 rounded-xl border outline-none" /></div>
                  <div><label className="block text-sm font-semibold mb-2">SSN / Tax ID</label><input required type="password" value={formData.taxId} onChange={(e) => updateField("taxId", e.target.value)} className="w-full px-4 py-3 rounded-xl border outline-none" /></div>
                  <div><label className="block text-sm font-semibold mb-2">DOB Year</label><input required type="number" placeholder="YYYY" value={formData.dobYear} onChange={(e) => updateField("dobYear", e.target.value)} className="w-full px-4 py-3 rounded-xl border outline-none" /></div>
                  ...
                  <div><label className="block text-sm font-semibold mb-2">State</label><input required value={formData.personalState} onChange={(e) => updateField("personalState", e.target.value)} className="w-full px-4 py-3 rounded-xl border outline-none" /></div>
                  <div><label className="block text-sm font-semibold mb-2">ZIP Code</label><input required value={formData.personalPostalCode} onChange={(e) => updateField("personalPostalCode", e.target.value)} className="w-full px-4 py-3 rounded-xl border outline-none" /></div>
                </div>
              </div>
            )}
